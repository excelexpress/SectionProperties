    ...
    public partial class SectionElements
    {
        public class IsoscelesTriangle : Shape
        {
            ...
            public override void Draw(ref Bitmap bitmap, PlotProperties plotprops)
            {
                ...
                path.AddLine(0, 0, (float)SF, (float)SF);
                path.AddLine((float)SF, (float)SF, (float)(2*SF), 0);
                path.AddLine((float)(2 * SF), 0, 0, 0);
                //path.AddLine(0, 0, -_b/2, 0);
                //path.AddLine(-_b/2, 0, 0, _h);
                //path.AddLine(0, 0, 0, _h);
                //path.AddLine(0, _h, _b/2, 0);
                //path.AddLine(_b / 2, 0, 0, 0);
                path.CloseFigure();
