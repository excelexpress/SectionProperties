    ...
    public partial class SectionElements
    {
        public class FormedZee : Shape
        {
            ...
            public override void Draw(ref Bitmap bitmap, PlotProperties plotprops)
            {
                ...
                path.AddArc(new System.Drawing.Rectangle(-2 * _r2, _h - _t - 2 * _r2, 2 * _r2, 2 * _r2), 0, 90);
                path.AddLine(-_r2, _h - _t, _t - _b2, _h - _t);
                path.AddLine(_t - _b2, _h - _t, _t - _b2, _h);
                path.AddLine(_t - _b2, _h, _t - _R2, _h);
                path.AddArc(new System.Drawing.Rectangle(_t - 2 * _R2, _h - 2 * _R2, 2 * _R2, 2 * _R2), 90, -90);
            ...
            protected override SecProp ShapeSecProp()
            {
                ...
                CircularArc bendu = new CircularArc { Material = Material, r = r2, t = t, phi = 90 * Math.PI / 180, point = "j", xp = t, yp = h, theta = 45 * Math.PI / 180 };
                Rectangle recl = new Rectangle { Material = Material, b = b1 - r1 - t, t = t, point = "a", xp = t + r1, yp = 0, theta = 0 };
                Rectangle recu = new Rectangle { Material = Material, b = b2 - r2 - t, t = t, point = "e", xp = -r2, yp = h, theta = 0 };
